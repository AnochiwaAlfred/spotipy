...
# from plugins.get_context import get_context
...
CUSTOM_ADMIN_NAVIGATION_TEMPLATE = 'spotipy/admin/app_list_nav.html'
CUSTOM_ADMIN_NAVIGATION_CONTEXT_NAME = 'custom_app_list'
...
LOGIN_URL = '/'
LOGIN_REDIRECT_URL = '/spotipy'
# LOGOUT_REDIRECT_URL = '/dashboard/logout'
